...
const configHeaders = (headers, factory) => new Proxy(factory, {
    apply(target, thisArg, argumentsList) {
...
const configToken = (tokenServiceUrl, client, factory) => new Proxy(factory, {
    apply(target, thisArg, argumentsList) {
...
// })(darwinHttp1);
const allFactoryConfig = pipe(addProviderCurrified(axios$1), configHeadersCurrified({ 'X-Requested-With': 'DarwinXMLHttpRequest' }), configTokenCurrified('https://accounts.spotify.com/api/token', {
